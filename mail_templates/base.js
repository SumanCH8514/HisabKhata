export const BRAND_LOGO_URL = 'https://hisabkhata.sumanonline.com/icons/icon-192x192.png';
export const APP_HOME_URL = 'https://hisabkhata.sumanonline.com/';
export const SUMAN_ONLINE_URL = 'https://sumanonline.com';

export function renderHeader(subtitle = 'A SumanOnline Project') {
  return `
    <tr>
...
export function wrapHtmlDoc(contentHtml, title = 'HisabKhata Notification') {
