    ...
    <tr>
      <td align="center" valign="top">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="max-width: 560px; background-color: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #e2e8f0; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td align="center" bgcolor="#0057BB" style="background-color: #0057BB; background: linear-gradient(135deg, #0057BB 0%, #003a80 100%); padding: 32px 24px; text-align: center;">
          ...
          <tr>
            <td style="padding: 28px 24px;">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 28px 0 8px 0;">
                <tr>
                  <td align="center">
                    <a href="${actionUrl}" target="_blank" style="display: inline-block; background-color: #0057BB; color: #ffffff !important; text-decoration: none; padding: 12px 26px; border-radius: 10px; font-size: 13px; font-weight: 700; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
                      View Complete Live Statement &rarr;
                    </a>
                  </td>
                </tr>
              </table>` : ''}
          ...
          <tr>
            <td align="center" bgcolor="#f8fafc" style="background-color: #f8fafc; border-top: 1px solid #e2e8f0; padding: 24px 20px; text-align: center;">
              ...
              <div style="color: #475569; font-size: 11px; max-width: 440px; margin: 0 auto; line-height: 1.5; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
                This is an official automated transaction advisory generated by <strong>HisabKhata</strong> for real-time ledger accounting.
              </div>
              ...
              <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid #f1f5f9; font-size: 11px; color: #64748b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif;">
                &copy; HisabKhata &bull; A <a href="https://sumanonline.com" target="_blank" style="color: #0057BB; font-weight: 700; text-decoration: none;">SumanOnline</a> Project
              </div>
            </td>
          </tr>
