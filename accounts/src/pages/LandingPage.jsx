    ...
    <div className="landing-page">
      <nav>
        <div className="container nav-container">
          <Link to="/" className="logo">
            <img src={logo} alt="HisabKhata Logo" className="nav-logo-img" />
          </Link>
      ...
      <header className="hero">
        <div className="container hero-grid">
          ...
          <div className="hero-image">
            <img src="/hero.png" alt="HisabKhata App Interface" />
          </div>
        </div>
      </header>
      ...
      <section className="security" id="security" style={{ padding: '100px 0', background: 'var(--white)' }}>
        <div className="container hero-grid" style={{ alignItems: 'center' }}>
          <div className="hero-image">
            <img src="/security.png" alt="Security Illustration" style={{ maxWidth: '500px' }} />
          </div>
          <div className="hero-content">
