...
const SignUp = () => {
    ...
    const { register, logout, sendVerification, loginWithGoogle, globalSettings } = useAuth();
    ...
    return (
        <div className="min-h-screen lg:h-screen flex flex-col lg:flex-row overflow-y-auto lg:overflow-hidden" style={{ fontFamily: "'Noto Sans', sans-serif" }}>
            <div className="hidden lg:flex flex-col justify-between w-[520px] flex-shrink-0 p-8 xl:p-10 text-white relative overflow-hidden"
                ...
                <div className="space-y-4 xl:space-y-5">
                    <h2 className="text-2xl xl:text-3xl font-bold text-white leading-tight">
                        Start digital bookkeeping<br />for your business
                    </h2>
                    <p className="text-[#9bbdd4] text-xs xl:text-sm leading-relaxed">
                        Say goodbye to paper bahi-khata. Create your store account and start tracking customer balances in seconds.
                    </p>

                    <div className="space-y-3 pt-1">
                        <div className="flex items-start gap-3 text-[#9bbdd4] text-xs xl:text-sm">
                            <span className="material-symbols-outlined text-emerald-400 text-[18px] shrink-0 mt-0.5">account_balance_wallet</span>
                            <div>
                                <strong className="text-white font-semibold block text-xs xl:text-sm">Real-time Balance Tracking</strong>
                                <span className="text-[11px] xl:text-xs text-[#9bbdd4]">Record Got & Gave entries with instant balance calculation.</span>
                            </div>
                        </div>

                        <div className="flex items-start gap-3 text-[#9bbdd4] text-xs xl:text-sm">
                            <span className="material-symbols-outlined text-emerald-400 text-[18px] shrink-0 mt-0.5">send</span>
                            <div>
                                <strong className="text-white font-semibold block text-xs xl:text-sm">WhatsApp & Email Statements</strong>
                                <span className="text-[11px] xl:text-xs text-[#9bbdd4]">Send balance reminders and digital receipts with one tap.</span>
                            </div>
                        </div>

                        <div className="flex items-start gap-3 text-[#9bbdd4] text-xs xl:text-sm">
                            <span className="material-symbols-outlined text-emerald-400 text-[18px] shrink-0 mt-0.5">cloud_done</span>
                            <div>
                                <strong className="text-white font-semibold block text-xs xl:text-sm">Automated Cloud Backup</strong>
                                <span className="text-[11px] xl:text-xs text-[#9bbdd4]">Never lose your records even if you switch or misplace your phone.</span>
                            </div>
                        </div>
                    </div>

                    <div className="p-3 xl:p-3.5 rounded-xl bg-white/5 border border-white/10 flex items-center gap-3">
                        <span className="material-symbols-outlined text-amber-400 text-[20px] shrink-0">speed</span>
                        <div className="text-[11px] xl:text-xs text-[#9bbdd4] leading-relaxed">
                            <span className="text-white font-semibold">Ready in 30 seconds: </span>
                            <span>No credit card required. Free forever for basic ledgers.</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex-1 flex lg:items-center items-start lg:justify-center justify-start pt-8 pb-20 px-6 bg-white overflow-y-auto">
                <div className="w-full max-w-[400px] lg:my-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-3">
                            <div>
                                ...
                                <input id="name" type="text" required placeholder="Enter your full name"
                                    className="w-full px-4 py-3 lg:py-2.5 border border-gray-300 rounded text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-100 transition-all"
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input id="password" type={showPassword ? 'text' : 'password'} required placeholder="••••••••"
                                        className="w-full px-4 py-3 lg:py-2.5 pr-12 border border-gray-300 rounded text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-100 transition-all"
                            ...
                            <button disabled={loading || (globalSettings?.captcha && !isCaptchaVerified)} type="submit"
                    ...
                    <p className="text-center text-sm text-gray-500 mt-6 lg:mt-5">
